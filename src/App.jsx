      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="mb-16 max-w-5xl mx-auto">
            <div className="rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(59,130,246,0.1)]">
              <div style={{ position: 'relative', width: '100%', height: 0, paddingBottom: '54.063%' }}>
                <iframe 
                  allow="fullscreen;autoplay" 
                  allowFullScreen 
                  height="100%" 
                  src="https://streamable.com/e/8pltao?autoplay=1&muted=1" 
                  width="100%" 
